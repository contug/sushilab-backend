...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private DettagliUtenteService jwtUserDetailsService;

	@Autowired
	private JwtRequestFilter jwtRequestFilter;
	
	@Autowired
	PasswordEncoderFunction passwordEncoder;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.authorizeRequests().antMatchers("/login", "/utente").permitAll().antMatchers(HttpMethod.OPTIONS, "/**").permitAll().
